...
tag="electricity_paper_uncertainty_asym_lgbm_shap"
model_name="pipeline_electricity_uncertainty_asym_lgbm_paper"
save_dir="./results/quick_electricity_experiments_paper/${tag}"
tsfm_cache_path="./results/quick_electricity_experiments_paper/tsfm_cache"
mkdir -p "$save_dir" "$tsfm_cache_path"

# Data / TSFM / regression config
is_std=1
enable_tsfm=1
pred_len=24
seq_len=168
...
# Custom asymmetric loss strength
