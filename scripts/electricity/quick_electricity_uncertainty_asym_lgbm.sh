...
tag="electricity_quick_uncertainty_asym_lgbm"
model_name="pipeline_electricity_uncertainty_asym_lgbm"
save_dir="./results/quick_electricity_experiments/${tag}"
tsfm_cache_path="./results/quick_electricity_experiments/tsfm_cache"
